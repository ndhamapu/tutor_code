package cio.common.spring.example3;
...
public class AdvanceApplication implements SmartLifecycle
{
	...
	/**
	 * an Integer value that tell when our Been needs to be Notified when the
	 * context is refreshed. if this beans value is higher than other beans Phase
	 * value then this bean will :
	 * <p>
	 * be called after that bean (whose values is less)when the system starts up
	 * </p>
	 * <p>
