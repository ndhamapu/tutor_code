package cio.common.spring.example1;
...
public class TradeService
{
	...
	{
		final boolean validTradeDate = gethService().isValidTradeDate(LocalDate.now());
	...
	public void sethService(final HolidayService hService)
	{
