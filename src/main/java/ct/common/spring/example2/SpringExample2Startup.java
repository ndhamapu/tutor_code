 ...
 * this example enhances the example 1 with checks and bit of best practices when coding a spring application.
 * this tells that they are not mandatory but will save a lot of hassle for other developers.
 * @author nikhil
 *
 */
