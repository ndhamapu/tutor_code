package ct.common.hibernate.example1;
...
public class Order
{
	...
	/**
	 * 'N' --> new 'M' --> modify 'X' --> Cancel
	 */
	private String orderState;
	/**
	 * Constructor used in Hibernate without the Order Id
	 */
	public Order(int instId, Side side, long quantity, double px, String clOrderId)
	{
