 ...
 * 1.	Define a thread called â€œPrintText_Threadâ€? for printing 
 ...
 * two threads and run them. Pass the text and n as parameters to the thread constructor. For Example:
 1. First Thread prints text asâ€? Gate way Of Indiaâ€? for 10 
 Times
 2. Second Thread prints text asâ€? India Gateâ€? for 20 times
